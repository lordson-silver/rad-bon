(function ($) {
    ...
    $(document).ready(function(){        
        ...
        function showResults() {
            ...
            var investedAmount = parseFloat($('.inputted-amount').val());
            ...
            partResult.find('.js_totalPercentage').html(totalPercent.toFixed(0) + '%');
            partResult.find('.js_dailyProfit').html(currencySign + dailyProfit.toFixed(2));
            partResult.find('.js_monthlyProfit').html(currencySign + monthlyProfit.toFixed(2));
